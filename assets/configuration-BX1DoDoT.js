const e="./docs/en/configuration.md",n=`---
...
`,t="2024-08-13",i="2026-01-24",o="Configuration",a="Learn how to configure Intlayer for your application. Understand the various settings and options available to customize Intlayer to your needs.",r=["Configuration","Settings","Customization","Intlayer","Options"],s=["doc","concept","configuration"],l=[{version:"8.0.0",date:"2026-01-24",changes:"Rename `live` import mode to `fetch` to better describe the underlying mechanism."},{version:"8.0.0",date:"2026-01-22",changes:"Move `importMode` build configuration to `dictionary` configuration."},{version:"8.0.0",date:"2026-01-22",changes:"Add `rewrite` option to the routing configuration"},{version:"8.0.0",date:"2026-01-18",changes:"Separate system configuration from content configuration. Move internal paths to `system` property. Add `codeDir` to separate content files from code transformation."},{version:"8.0.0",date:"2026-01-18",changes:"Add `location` and `schema` dictionary options"},{version:"7.5.1",date:"2026-01-10",changes:"Add support for JSON5 and JSONC file formats"},{version:"7.5.0",date:"2025-12-17",changes:"Add `buildMode` option"},{version:"7.0.0",date:"2025-10-25",changes:"Add `dictionary` configuration"},{version:"7.0.0",date:"2025-10-21",changes:"Replace `middleware` by `routing` configuration"},{version:"7.0.0",date:"2025-10-12",changes:"Add `formatCommand` option"},{version:"6.2.0",date:"2025-10-12",changes:"Update `excludedPath` option"},{version:"6.0.2",date:"2025-09-23",changes:"Add `outputFormat` option"},{version:"6.0.0",date:"2025-09-21",changes:"Remove `dictionaryOutput` field and `i18nextResourcesDir` field"},{version:"6.0.0",date:"2025-09-16",changes:"Add `live` import mode"},{version:"6.0.0",date:"2025-09-04",changes:"Replace `hotReload` field by `liveSync` and add `liveSyncPort` and `liveSyncURL` fields"},{version:"5.6.1",date:"2025-07-25",changes:"Replace `activateDynamicImport` with `importMode` option"},{version:"5.6.0",date:"2025-07-13",changes:"Change default contentDir from `['src']` to `['.']`"},{version:"5.5.11",date:"2025-06-29",changes:"Add `docs` commands"}],c="./docs/en/configuration.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/configuration.md",p="/doc/concept/configuration",u="https://intlayer.org/doc/concept/configuration",f={id:e,content:n,createdAt:t,updatedAt:i,title:o,description:a,keywords:r,slugs:s,history:l,docKey:c,githubUrl:d,relativeUrl:p,url:u};export{n as content,t as createdAt,f as default,a as description,c as docKey,d as githubUrl,l as history,e as id,r as keywords,p as relativeUrl,s as slugs,o as title,i as updatedAt,u as url};
