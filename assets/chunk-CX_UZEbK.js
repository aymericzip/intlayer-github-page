const e="./docs/en/mcp_server.md",n=`---
...
---
`,t="2025-06-07",o="2025-07-11",r="MCP Server Documentation",s="Explore the features and setup of the MCP Server to optimize your server management and operations.",a=["MCP Server","Server Management","Optimization","Intlayer","Documentation","Setup","Features"],i=["doc","mcp-server"],c=[{version:"5.5.12",date:"2025-07-11",changes:"Add set up of ChatGPT"},{version:"5.5.12",date:"2025-07-10",changes:"Add set up of Claude Desktop"},{version:"5.5.12",date:"2025-07-10",changes:"Add SSE transport and distant server"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],l="./docs/en/mcp_server.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/mcp_server.md",m="/doc/mcp-server",u="https://intlayer.org/doc/mcp-server",p={id:e,content:n,createdAt:t,updatedAt:o,title:r,description:s,keywords:a,slugs:i,history:c,docKey:l,githubUrl:d,relativeUrl:m,url:u};export{n as content,t as createdAt,p as default,s as description,l as docKey,d as githubUrl,c as history,e as id,a as keywords,m as relativeUrl,i as slugs,r as title,o as updatedAt,u as url};
