const e="./docs/en/packages/react-intlayer/useLocale.md",n=`---
...
`,a="2025-08-23",o="2025-08-23",t="useLocale Hook Documentation | react-intlayer",c="See how to use the useLocale hook for react-intlayer package",l=["useLocale","dictionary","key","Intlayer","Internationalization","Documentation","Next.js","JavaScript","React"],s=["doc","packages","react-intlayer","useLocale"],r=[{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],i="./docs/en/packages/react-intlayer/useLocale.md",u="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/react-intlayer/useLocale.md",p="/doc/packages/react-intlayer/useLocale",L="https://intlayer.org/doc/packages/react-intlayer/useLocale",h={id:e,content:n,createdAt:a,updatedAt:o,title:t,description:c,keywords:l,slugs:s,history:r,docKey:i,githubUrl:u,relativeUrl:p,url:L};export{n as content,a as createdAt,h as default,c as description,i as docKey,u as githubUrl,r as history,e as id,l as keywords,p as relativeUrl,s as slugs,t as title,o as updatedAt,L as url};
