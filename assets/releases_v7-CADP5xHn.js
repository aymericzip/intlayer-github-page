const e="./docs/en/releases/v7.md",n=`---
...
`,t="2025-09-22",o="2025-09-23",i="New Intlayer v7 - What's new?",a="Discover what's new in Intlayer v7. Major improvements in performance, developer experience, and new features to enhance your internationalization workflow.",r=["Intlayer","Localization","Development","Performance","Developer Experience","Features","React","Next.js","JavaScript","TypeScript"],l=["doc","releases","v7"],s="./docs/en/releases/v7.md",c="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/releases/v7.md",d="/doc/releases/v7",p="https://intlayer.org/doc/releases/v7",f={id:e,content:n,createdAt:t,updatedAt:o,title:i,description:a,keywords:r,slugs:l,docKey:s,githubUrl:c,relativeUrl:d,url:p};export{n as content,t as createdAt,f as default,a as description,s as docKey,c as githubUrl,e as id,r as keywords,d as relativeUrl,l as slugs,i as title,o as updatedAt,p as url};
