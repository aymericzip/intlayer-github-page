const n="./docs/en/dictionary/gender.md",e=`---
...
`,t="2025-07-27",o="2025-07-27",r="Gender-Based Content",a="Learn how to use gender-based content in Intlayer to dynamically display content based on gender. Follow this documentation to implement gender-specific content efficiently in your project.",c=["Gender-Based Content","Dynamic Rendering","Documentation","Intlayer","Next.js","JavaScript","React"],i=["doc","concept","content","gender"],s=[{version:"5.7.2",date:"2025-07-27",changes:"Introduce gender based content"}],d="./docs/en/dictionary/gender.md",m="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/gender.md",y="/doc/concept/content/gender",l="https://intlayer.org/doc/concept/content/gender",p={id:n,content:e,createdAt:t,updatedAt:o,title:r,description:a,keywords:c,slugs:i,history:s,docKey:d,githubUrl:m,relativeUrl:y,url:l};export{e as content,t as createdAt,p as default,a as description,d as docKey,m as githubUrl,s as history,n as id,c as keywords,y as relativeUrl,i as slugs,r as title,o as updatedAt,l as url};
