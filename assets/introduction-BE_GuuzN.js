const n="./docs/en/introduction.md",t=`---
...
---
`,e="2025-08-23",o="2025-08-23",i="Introduction",a="Discover how Intlayer works. See the steps used by Intlayer in your application. See what does the different packages do.",r=["Introduction","Get started","Intlayer","Application","Packages"],s=["doc","get-started"],c=[{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],l="./docs/en/introduction.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/introduction.md",m="/doc/get-started",y="https://intlayer.org/doc/get-started",p={id:n,content:t,createdAt:e,updatedAt:o,title:i,description:a,keywords:r,slugs:s,history:c,docKey:l,githubUrl:d,relativeUrl:m,url:y};export{t as content,e as createdAt,p as default,a as description,l as docKey,d as githubUrl,c as history,n as id,r as keywords,m as relativeUrl,s as slugs,i as title,o as updatedAt,y as url};
