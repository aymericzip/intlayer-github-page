const n="./docs/en/packages/next-intlayer/useDictionary.md",e=`---
...
`,t="2025-08-23",o="2025-08-23",i="useDictionary Hook Documentation | next-intlayer",c="See how to use the useDictionary hook for next-intlayer package",a=["useDictionary","dictionary","key","Intlayer","Internationalization","Documentation","Next.js","JavaScript","React"],r=["doc","packages","next-intlayer","useDictionary"],s=[{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],p="./docs/en/packages/next-intlayer/useDictionary.md",l="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/next-intlayer/useDictionary.md",m="/doc/packages/next-intlayer/useDictionary",d="https://intlayer.org/doc/packages/next-intlayer/useDictionary",y={id:n,content:e,createdAt:t,updatedAt:o,title:i,description:c,keywords:a,slugs:r,history:s,docKey:p,githubUrl:l,relativeUrl:m,url:d};export{e as content,t as createdAt,y as default,c as description,p as docKey,l as githubUrl,s as history,n as id,a as keywords,m as relativeUrl,r as slugs,i as title,o as updatedAt,d as url};
