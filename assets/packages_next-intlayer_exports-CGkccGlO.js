const e="./docs/en/packages/next-intlayer/exports.md",n=`---
...
`,t="2026-01-21",r="2026-01-21",o="next-intlayer Package Documentation",a="Next.js-specific integration for Intlayer, providing middleware and providers for App Router and Page Router.",i=["next-intlayer","nextjs","react","internationalization","i18n"],s=["doc","packages","next-intlayer","exports"],c=[{version:"8.0.0",date:"2026-01-21",changes:"Unified documentation for all exports"}],l="./docs/en/packages/next-intlayer/exports.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/next-intlayer/exports.md",p="/doc/packages/next-intlayer/exports",y="https://intlayer.org/doc/packages/next-intlayer/exports",u={id:e,content:n,createdAt:t,updatedAt:r,title:o,description:a,keywords:i,slugs:s,history:c,docKey:l,githubUrl:d,relativeUrl:p,url:y};export{n as content,t as createdAt,u as default,a as description,l as docKey,d as githubUrl,c as history,e as id,i as keywords,p as relativeUrl,s as slugs,o as title,r as updatedAt,y as url};
