const n="./docs/en/dictionary/condition.md",t=`---
...
`,o="2025-02-07",e="2025-06-29",i="Conditional Content",a="Learn how to use conditional content in Intlayer to dynamically display content based on specific conditions. Follow this documentation to implement conditions efficiently in your project.",c=["Conditional Content","Dynamic Rendering","Documentation","Intlayer","Next.js","JavaScript","React"],s=["doc","concept","content","condition"],r=[{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],d="./docs/en/dictionary/condition.md",l="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/condition.md",y="/doc/concept/content/condition",m="https://intlayer.org/doc/concept/content/condition",p={id:n,content:t,createdAt:o,updatedAt:e,title:i,description:a,keywords:c,slugs:s,history:r,docKey:d,githubUrl:l,relativeUrl:y,url:m};export{t as content,o as createdAt,p as default,a as description,d as docKey,l as githubUrl,r as history,n as id,c as keywords,y as relativeUrl,s as slugs,i as title,e as updatedAt,m as url};
