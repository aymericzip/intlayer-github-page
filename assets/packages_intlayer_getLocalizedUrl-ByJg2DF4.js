const e="./docs/en/packages/intlayer/getLocalizedUrl.md",n=`---
...
`,o="2025-08-23",a="2025-11-16",t="getLocalizedUrl Function Documentation | intlayer",l="See how to use the getLocalizedUrl function for intlayer package",i=["getLocalizedUrl","translation","Intlayer","intlayer","Internationalization","Documentation","Next.js","JavaScript","React"],r=["doc","packages","intlayer","getLocalizedUrl"],c=[{version:"7.1.0",date:"2025-11-16",changes:"Refactored to use options parameter with mode instead of prefixDefault"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],s="./docs/en/packages/intlayer/getLocalizedUrl.md",p="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/intlayer/getLocalizedUrl.md",u="/doc/packages/intlayer/getLocalizedUrl",d="https://intlayer.org/doc/packages/intlayer/getLocalizedUrl",f={id:e,content:n,createdAt:o,updatedAt:a,title:t,description:l,keywords:i,slugs:r,history:c,docKey:s,githubUrl:p,relativeUrl:u,url:d};export{n as content,o as createdAt,f as default,l as description,s as docKey,p as githubUrl,c as history,e as id,i as keywords,u as relativeUrl,r as slugs,t as title,a as updatedAt,d as url};
