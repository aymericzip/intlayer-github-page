const e="./docs/en/packages/next-intlayer/useLocale.md",n=`---
...
`,o="2025-08-23",t="2026-01-26",a="useLocale Hook Documentation | next-intlayer",l="See how to use the useLocale hook for next-intlayer package",c=["useLocale","dictionary","key","Intlayer","Internationalization","Documentation","Next.js","JavaScript","React"],i=["doc","packages","next-intlayer","useLocale"],s=[{version:"8.0.0",date:"2026-01-26",changes:"Default `onLocaleChange` to `replace`"},{version:"6.2.0",date:"2025-10-09",changes:"Added docs for `useLocale` hook with `onLocaleChange` option"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],r="./docs/en/packages/next-intlayer/useLocale.md",h="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/next-intlayer/useLocale.md",u="/doc/packages/next-intlayer/useLocale",d="https://intlayer.org/doc/packages/next-intlayer/useLocale",p={id:e,content:n,createdAt:o,updatedAt:t,title:a,description:l,keywords:c,slugs:i,history:s,docKey:r,githubUrl:h,relativeUrl:u,url:d};export{n as content,o as createdAt,p as default,l as description,r as docKey,h as githubUrl,s as history,e as id,c as keywords,u as relativeUrl,i as slugs,a as title,t as updatedAt,d as url};
