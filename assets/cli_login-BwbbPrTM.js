const n="./docs/en/cli/login.md",e=`---
...
`,t="2025-12-16",o="2025-12-16",i="CLI - Login",r="Learn how to use the Intlayer CLI login command to authenticate with the Intlayer CMS and obtain access credentials.",a=["CLI","Login","Authentication","CMS","Intlayer","Credentials"],c=["doc","concept","cli","login"],l="./docs/en/cli/login.md",s="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/cli/login.md",d="/doc/concept/cli/login",h="https://intlayer.org/doc/concept/cli/login",u={id:n,content:e,createdAt:t,updatedAt:o,title:i,description:r,keywords:a,slugs:c,docKey:l,githubUrl:s,relativeUrl:d,url:h};export{e as content,t as createdAt,u as default,r as description,l as docKey,s as githubUrl,n as id,a as keywords,d as relativeUrl,c as slugs,i as title,o as updatedAt,h as url};
