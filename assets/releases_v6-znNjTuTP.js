const n="./docs/en/releases/v6.md",e=`---
...
`,t="2025-09-22",i="2025-09-23",o="New Intlayer v6 - What's new?",a="Discover what's new in Intlayer v6. Major improvements in performance, developer experience, and new features to enhance your internationalization workflow.",s=["Intlayer","Localization","Development","Performance","Developer Experience","Features","React","Next.js","JavaScript","TypeScript"],r=["doc","releases","v6"],l="./docs/en/releases/v6.md",c="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/releases/v6.md",d="/doc/releases/v6",m="https://intlayer.org/doc/releases/v6",p={id:n,content:e,createdAt:t,updatedAt:i,title:o,description:a,keywords:s,slugs:r,docKey:l,githubUrl:c,relativeUrl:d,url:m};export{e as content,t as createdAt,p as default,a as description,l as docKey,c as githubUrl,n as id,s as keywords,d as relativeUrl,r as slugs,o as title,i as updatedAt,m as url};
