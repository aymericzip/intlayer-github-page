const n="./docs/en/formatters.md",e=`---
...
`,t="2024-08-13",a="2026-01-20",r="Formatters",o="Locale-aware formatting utilities based on Intl for numbers, percentages, currency, dates, relative time, units, and compact notation. Includes a cached Intl helper.",l=["Formatters","Intl","Number","Currency","Percentage","Date","Relative Time","Units","Compact","List","Internationalization"],s=["doc","formatters"],i=[{version:"8.0.0",date:"2026-01-20",changes:"Add useIntl"},{version:"6.2.0",date:"2025-10-14",changes:"Remove getIntlayerAsync from formatters"},{version:"5.8.0",date:"2025-08-20",changes:"Add vue formatters"},{version:"5.8.0",date:"2025-08-18",changes:"Add formatters documentation"},{version:"5.8.0",date:"2025-08-20",changes:"Add list formatter documentation"},{version:"5.8.0",date:"2025-08-20",changes:"Add additional Intl utilities (DisplayNames, Collator, PluralRules)"},{version:"5.8.0",date:"2025-08-20",changes:"Add locale utilities (getLocaleName, getLocaleLang, getLocaleFromPath, etc.)"},{version:"5.8.0",date:"2025-08-20",changes:"Add content handling utilities (getContent, getTranslation, getIntlayer, etc.)"}],c="./docs/en/formatters.md",u="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/formatters.md",m="/doc/formatters",p="https://intlayer.org/doc/formatters",d={id:n,content:e,createdAt:t,updatedAt:a,title:r,description:o,keywords:l,slugs:s,history:i,docKey:c,githubUrl:u,relativeUrl:m,url:p};export{e as content,t as createdAt,d as default,o as description,c as docKey,u as githubUrl,i as history,n as id,l as keywords,m as relativeUrl,s as slugs,r as title,a as updatedAt,p as url};
