const e="./docs/en/intlayer_with_nextjs_14.md",n=`---
...
`,t="2024-12-06",a="2025-12-30",o="Next.js i18n - How to translate your Next.js 14 app – guide 2026",r="Discover how to make your Next.js 14 App Router website multilingual. Follow the documentation to internationalize (i18n) and translate it.",i=["Internationalization","Documentation","Intlayer","Next.js 14","JavaScript","React"],l=["doc","environment","nextjs","14"],s="https://github.com/aymericzip/intlayer-next-14-template",c=[{version:"7.5.9",date:"2025-12-30",changes:"Add init command"},{version:"6.2.0",date:"2025-10-09",changes:"Added docs for `useLocale` hook with `onLocaleChange` option"},{version:"5.6.6",date:"2025-10-02",changes:"Added docs for `getLocale` function on server actions"},{version:"5.6.2",date:"2025-09-22",changes:"Added docs for `multipleMiddlewares` helper"},{version:"5.6.0",date:"2025-07-06",changes:"Transform `withIntlayer()` function to a promise based function"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],p="./docs/en/intlayer_with_nextjs_14.md",m="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_14.md",d="/doc/environment/nextjs/14",u="https://intlayer.org/doc/environment/nextjs/14",g={id:e,content:n,createdAt:t,updatedAt:a,title:o,description:r,keywords:i,slugs:l,applicationTemplate:s,history:c,docKey:p,githubUrl:m,relativeUrl:d,url:u};export{s as applicationTemplate,n as content,t as createdAt,g as default,r as description,p as docKey,m as githubUrl,c as history,e as id,i as keywords,d as relativeUrl,l as slugs,o as title,a as updatedAt,u as url};
