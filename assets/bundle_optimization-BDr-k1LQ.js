const n="./docs/en/bundle_optimization.md",e=`---
...
`,t="2025-11-25",i="2025-11-25",o="Optimizing i18n Bundle Size & Performance",a="Reduce application bundle size by optimizing internationalization (i18n) content. Learn how to leverage tree shaking and lazy loading for dictionaries with Intlayer.",s=["Bundle Optimization","Content Automation","Dynamic Content","Intlayer","Next.js","JavaScript","React"],r=["doc","concept","bundle-optimization"],l=[{version:"6.0.0",date:"2025-11-25",changes:"Init history"}],c="./docs/en/bundle_optimization.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/bundle_optimization.md",u="/doc/concept/bundle-optimization",p="https://intlayer.org/doc/concept/bundle-optimization",m={id:n,content:e,createdAt:t,updatedAt:i,title:o,description:a,keywords:s,slugs:r,history:l,docKey:c,githubUrl:d,relativeUrl:u,url:p};export{e as content,t as createdAt,m as default,a as description,c as docKey,d as githubUrl,l as history,n as id,s as keywords,u as relativeUrl,r as slugs,o as title,i as updatedAt,p as url};
