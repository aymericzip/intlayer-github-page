const n="./docs/en/intlayer_with_adonisjs.md",e=`---
...
.intlayer
\`\`\`
`,t="2025-08-23",o="2025-12-30",a="AdonisJS i18n - How to translate your AdonisJS app – guide 2026",i="Discover how to make your AdonisJS backend multilingual. Follow the documentation to internationalize (i18n) and translate it.",s=["Internationalization","Documentation","Intlayer","AdonisJS","JavaScript","Backend"],r=["doc","environment","adonisjs"],l="https://github.com/aymericzip/intlayer-adonisjs-template",c=[{version:"8.0.0",date:"2025-12-30",changes:"Init history"}],d="./docs/en/intlayer_with_adonisjs.md",p="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_adonisjs.md",m="/doc/environment/adonisjs",y="https://intlayer.org/doc/environment/adonisjs",u={id:n,content:e,createdAt:t,updatedAt:o,title:a,description:i,keywords:s,slugs:r,applicationTemplate:l,history:c,docKey:d,githubUrl:p,relativeUrl:m,url:y};export{l as applicationTemplate,e as content,t as createdAt,u as default,i as description,d as docKey,p as githubUrl,c as history,n as id,s as keywords,m as relativeUrl,r as slugs,a as title,o as updatedAt,y as url};
