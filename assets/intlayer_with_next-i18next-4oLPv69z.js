const n="./docs/en/intlayer_with_next-i18next.md",e=`---
...
`,t="2025-10-05",a="2025-10-05",o="Next.js and next-i18next i18n - How to translate your Next.js app – guide 2026",s="A practical, production-ready guide to internationalize a Next.js 15 App Router app with i18next/next-i18next and enhance it with Intlayer.",i=["Internationalization","Documentation","Intlayer","Next.js 15","next-i18next","i18next","JavaScript","React"],l=["doc","next-i18next"],r="https://github.com/aymericzip/intlayer-next-i18next-template",c="./docs/en/intlayer_with_next-i18next.md",p="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_next-i18next.md",d="/doc/next-i18next",m="https://intlayer.org/doc/next-i18next",u={id:n,content:e,createdAt:t,updatedAt:a,title:o,description:s,keywords:i,slugs:l,applicationTemplate:r,docKey:c,githubUrl:p,relativeUrl:d,url:m};export{r as applicationTemplate,e as content,t as createdAt,u as default,s as description,c as docKey,p as githubUrl,n as id,i as keywords,d as relativeUrl,l as slugs,o as title,a as updatedAt,m as url};
