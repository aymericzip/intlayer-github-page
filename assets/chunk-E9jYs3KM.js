const n="./docs/en/per_locale_file.md",e=`---
...
`,t="2025-04-18",o="2025-06-29",l="Declaration of `Per-Locale` Content Declaration in Intlayer",a="Discover how to declare content per locale in Intlayer. Follow the documentation to understand the different formats and use cases.",i=["Internationalization","Documentation","Intlayer","Per-Locale","TypeScript","JavaScript"],r=["doc","concept","per-locale-file"],c=[{version:"7.3.1",date:"2025-11-29",changes:"Add global configuration for per-locale files"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],s="./docs/en/per_locale_file.md",m="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/per_locale_file.md",d="/doc/concept/per-locale-file",p="https://intlayer.org/doc/concept/per-locale-file",y={id:n,content:e,createdAt:t,updatedAt:o,title:l,description:a,keywords:i,slugs:r,history:c,docKey:s,githubUrl:m,relativeUrl:d,url:p};export{e as content,t as createdAt,y as default,a as description,s as docKey,m as githubUrl,c as history,n as id,i as keywords,d as relativeUrl,r as slugs,l as title,o as updatedAt,p as url};
