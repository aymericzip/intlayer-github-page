const e="./docs/en/custom_url_rewrites.md",n=`---
...
`,t="2024-08-13",r="2026-01-26",o="Custom URL Rewrites",a="Learn how to configure and use custom URL rewrites in Intlayer to define locale-specific paths.",i=["Custom URL Rewrites","Routing","Internationalization","i18n"],l=["doc","concept","custom_url_rewrites"],s=[{version:"8.0.0",date:"2026-01-25",changes:"Implement centralized URL rewrites with framework-specific formatters and the useRewriteURL hook."}],c="./docs/en/custom_url_rewrites.md",u="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/custom_url_rewrites.md",p="/doc/concept/custom_url_rewrites",d="https://intlayer.org/doc/concept/custom_url_rewrites",f={id:e,content:n,createdAt:t,updatedAt:r,title:o,description:a,keywords:i,slugs:l,history:s,docKey:c,githubUrl:u,relativeUrl:p,url:d};export{n as content,t as createdAt,f as default,a as description,c as docKey,u as githubUrl,s as history,e as id,i as keywords,p as relativeUrl,l as slugs,o as title,r as updatedAt,d as url};
