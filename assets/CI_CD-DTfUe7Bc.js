...
> For more information about Intlayer CLI commands and their usage, refer to the [CLI documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/cli/index.md).
`,t="2025-05-20",o="2025-08-13",i="CI/CD Integration",a="Learn how to integrate Intlayer into your CI/CD pipeline for automated content management and deployment.",s=["CI/CD","Continuous Integration","Continuous Deployment","Automation","Internationalization","Documentation","Intlayer"],l=["doc","concept","ci-cd"],r=[{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],c="./docs/en/CI_CD.md",u="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/CI_CD.md",d="/doc/concept/ci-cd",p="https://intlayer.org/doc/concept/ci-cd",m={id:n,content:e,createdAt:t,updatedAt:o,title:i,description:a,keywords:s,slugs:l,history:r,docKey:c,githubUrl:u,relativeUrl:d,url:p};export{e as content,t as createdAt,m as default,a as description,c as docKey,u as githubUrl,r as history,n as id,s as keywords,d as relativeUrl,l as slugs,i as title,o as updatedAt,p as url};
