const e="./docs/en/packages/intlayer/getPrefix.md",n=`---
...
\`\`\`
`,t="2025-11-16",i="2025-11-16",r="getPrefix Function Documentation | intlayer",o="See how to use the getPrefix function for intlayer package",a=["getPrefix","prefix","Intlayer","intlayer","Internationalization","Documentation","Next.js","JavaScript","React"],l=["doc","packages","intlayer","getPrefix"],c=[{version:"7.1.0",date:"2025-11-16",changes:"Initial documentation"}],f="./docs/en/packages/intlayer/getPrefix.md",s="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/intlayer/getPrefix.md",p="/doc/packages/intlayer/getPrefix",d="https://intlayer.org/doc/packages/intlayer/getPrefix",u={id:e,content:n,createdAt:t,updatedAt:i,title:r,description:o,keywords:a,slugs:l,history:c,docKey:f,githubUrl:s,relativeUrl:p,url:d};export{n as content,t as createdAt,u as default,o as description,f as docKey,s as githubUrl,c as history,e as id,a as keywords,p as relativeUrl,l as slugs,r as title,i as updatedAt,d as url};
