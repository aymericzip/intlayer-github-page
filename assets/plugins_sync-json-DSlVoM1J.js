const n="./docs/en/plugins/sync-json.md",e=`---
...
`,t="2025-03-13",i="2025-12-13",o="Sync JSON plugin",a="Synchronize Intlayer dictionaries with third‑party i18n JSON files (i18next, next-intl, react-intl, vue-i18n, and more). Keep your existing i18n while using Intlayer to manage, translate, and test your messages.",s=["Intlayer","Sync JSON","i18next","next-intl","react-intl","vue-i18n","next-translate","nuxt-i18n","LinguiJS","Polyglot.js","Solid-i18next","svelte-i18n","i18n","translations"],l=["doc","plugin","sync-json"],r="https://www.youtube.com/watch?v=MpGMxniDHNg",c=[{version:"7.5.0",date:"2025-12-13",changes:"Add ICU and i18next format support"},{version:"6.1.6",date:"2025-10-05",changes:"Initial Sync JSON plugin documentation"}],u="./docs/en/plugins/sync-json.md",y="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/plugins/sync-json.md",d="/doc/plugin/sync-json",f="https://intlayer.org/doc/plugin/sync-json",p={id:n,content:e,createdAt:t,updatedAt:i,title:o,description:a,keywords:s,slugs:l,youtubeVideo:r,history:c,docKey:u,githubUrl:y,relativeUrl:d,url:f};export{e as content,t as createdAt,p as default,a as description,u as docKey,y as githubUrl,c as history,n as id,s as keywords,d as relativeUrl,l as slugs,o as title,i as updatedAt,f as url,r as youtubeVideo};
