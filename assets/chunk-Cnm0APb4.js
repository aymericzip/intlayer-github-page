...
- \`./index.content.json\`
- \`./index.content.json\`
`,t="2025-03-13",l="2025-09-20",o="Auto Fill",i="Learn how to use auto fill functionality in Intlayer to automatically populate content based on predefined patterns. Follow this documentation to implement auto fill features efficiently in your project.",a=["Auto Fill","Content Automation","Dynamic Content","Intlayer","Next.js","JavaScript","React"],s=["doc","concept","auto-fill"],c=[{version:"7.0.0",date:"2025-10-23",changes:"Rename `autoFill` to `fill` and update behavior"},{version:"6.0.0",date:"2025-09-20",changes:"Add global configuration"},{version:"6.0.0",date:"2025-09-17",changes:"Add `{{fileName}}` variable"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],r="./docs/en/autoFill.md",f="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/autoFill.md",d="/doc/concept/auto-fill",m="https://intlayer.org/doc/concept/auto-fill",p={id:e,content:n,createdAt:t,updatedAt:l,title:o,description:i,keywords:a,slugs:s,history:c,docKey:r,githubUrl:f,relativeUrl:d,url:m};export{n as content,t as createdAt,p as default,i as description,r as docKey,f as githubUrl,c as history,e as id,a as keywords,d as relativeUrl,s as slugs,o as title,l as updatedAt,m as url};
