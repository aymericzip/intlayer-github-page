const n="./docs/en/dictionary/html.md",e=`---
...
`,t="2026-01-20",r="2026-01-22",o="HTML Content",a="Learn how to declare and use HTML content with custom components in Intlayer. Follow this documentation to embed rich HTML-like content with dynamic component replacement in your internationalized project.",i=["HTML","Custom Components","Rich Content","Intlayer","Next.js","JavaScript","React","Vue","Svelte"],l=["doc","concept","content","html"],s=[{version:"8.0.0",date:"2026-01-22",changes:"Add HTMLRenderer / useHTMLRenderer / renderHTML utility"},{version:"8.0.0",date:"2026-01-20",changes:"Add HTML parsing support"}],p="./docs/en/dictionary/html.md",c="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/html.md",d="/doc/concept/content/html",m="https://intlayer.org/doc/concept/content/html",u={id:n,content:e,createdAt:t,updatedAt:r,title:o,description:a,keywords:i,slugs:l,history:s,docKey:p,githubUrl:c,relativeUrl:d,url:m};export{e as content,t as createdAt,u as default,a as description,p as docKey,c as githubUrl,s as history,n as id,i as keywords,d as relativeUrl,l as slugs,o as title,r as updatedAt,m as url};
