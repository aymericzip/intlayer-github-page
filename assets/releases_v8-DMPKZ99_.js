const n="./docs/en/releases/v8.md",e=`---
...
For more details, see the [HTML Content Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/html.md) and [Markdown Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/markdown.md).
...
`,t="2025-09-22",r="2026-01-26",o="New Intlayer v8 - What's new?",i="Discover what's new in Intlayer v8. Major improvements in developer experience, content validation, and dictionary management.",a=["Intlayer","CMS","Developer Experience","Features","React","Next.js","JavaScript","TypeScript"],l="https://www.youtube.com/watch?v=ia6JmVf-kkU",s=["doc","releases","v8"],c="./docs/en/releases/v8.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/releases/v8.md",m="/doc/releases/v8",p="https://intlayer.org/doc/releases/v8",u={id:n,content:e,createdAt:t,updatedAt:r,title:o,description:i,keywords:a,youtubeVideo:l,slugs:s,docKey:c,githubUrl:d,relativeUrl:m,url:p};export{e as content,t as createdAt,u as default,i as description,c as docKey,d as githubUrl,n as id,a as keywords,m as relativeUrl,s as slugs,o as title,r as updatedAt,p as url,l as youtubeVideo};
