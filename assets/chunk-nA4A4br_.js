const n="./docs/en/packages/next-intlayer/useIntlayer.md",e=`---
...
`,t="2025-08-23",o="2025-08-23",r="useIntlayer Hook Documentation | next-intlayer",a="See how to use the useIntlayer hook for next-intlayer package",i=["useIntlayer","dictionary","key","Intlayer","Internationalization","Documentation","Next.js","JavaScript","React"],l=["doc","packages","next-intlayer","useIntlayer"],s=[{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],c="./docs/en/packages/next-intlayer/useIntlayer.md",m="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/packages/next-intlayer/useIntlayer.md",p="/doc/packages/next-intlayer/useIntlayer",y="https://intlayer.org/doc/packages/next-intlayer/useIntlayer",d={id:n,content:e,createdAt:t,updatedAt:o,title:r,description:a,keywords:i,slugs:l,history:s,docKey:c,githubUrl:m,relativeUrl:p,url:y};export{e as content,t as createdAt,d as default,a as description,c as docKey,m as githubUrl,s as history,n as id,i as keywords,p as relativeUrl,l as slugs,r as title,o as updatedAt,y as url};
