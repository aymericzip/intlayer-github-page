const a="./docs/en/locale_mapper.md",e=`---
...
`,n="2025-07-27",l="2025-07-27",t="Locale Mapper",o="Discover how Locale Mapper works. See the steps used by Locale Mapper in your application. See what does the different packages do.",c=["Locale Mapper","Get started","Intlayer","Application","Packages"],r=["doc","locale-mapper"],i=[{version:"5.7.2",date:"2025-07-27",changes:"Add locale mapper documentation"}],s="./docs/en/locale_mapper.md",p="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/locale_mapper.md",u="/doc/locale-mapper",d="https://intlayer.org/doc/locale-mapper",f={id:a,content:e,createdAt:n,updatedAt:l,title:t,description:o,keywords:c,slugs:r,history:i,docKey:s,githubUrl:p,relativeUrl:u,url:d};export{e as content,n as createdAt,f as default,o as description,s as docKey,p as githubUrl,i as history,a as id,c as keywords,u as relativeUrl,r as slugs,t as title,l as updatedAt,d as url};
