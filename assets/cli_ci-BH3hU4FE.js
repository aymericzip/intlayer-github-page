...
`,t="2026-01-06",o="2026-01-06",a="CI Command",i="Learn how to use the Intlayer CI command to run Intlayer commands with auto-injected credentials in CI/CD pipelines and monorepos.",c=["CI","CI/CD","Automation","Monorepo","Credentials","CLI","Intlayer"],r=["doc","concept","cli","ci"],s=[{version:"7.5.11",date:"2026-01-06",changes:"Add CI command"}],l="./docs/en/cli/ci.md",m="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/cli/ci.md",d="/doc/concept/cli/ci",p="https://intlayer.org/doc/concept/cli/ci",u={id:n,content:e,createdAt:t,updatedAt:o,title:a,description:i,keywords:c,slugs:r,history:s,docKey:l,githubUrl:m,relativeUrl:d,url:p};export{e as content,t as createdAt,u as default,i as description,l as docKey,m as githubUrl,s as history,n as id,c as keywords,d as relativeUrl,r as slugs,a as title,o as updatedAt,p as url};
