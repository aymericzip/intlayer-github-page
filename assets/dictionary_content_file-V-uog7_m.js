const n="./docs/en/dictionary/content_file.md",e=`---
...
`,t="2025-02-07",o="2026-01-28",i="Content File",a="Learn how to customize the extensions for your content declaration files. Follow this documentation to implement conditions efficiently in your project.",r=["Content File","Documentation","Intlayer"],s=["doc","concept","content"],l=[{version:"8.0.0",date:"2026-01-28",changes:"Add `html` content node type"},{version:"8.0.0",date:"2026-01-24",changes:"Rename `live` import mode to `fetch` to better describe the underlying mechanism."},{version:"8.0.0",date:"2026-01-18",changes:"Add `location`, `schema`, and `importMode` dictionary options"},{version:"7.5.13",date:"2026-01-10",changes:"Add support for JSON5 and JSONC file formats"},{version:"7.5.0",date:"2025-12-13",changes:"Add ICU and i18next format support"},{version:"7.0.0",date:"2025-10-23",changes:"Rename `autoFill` to `fill`"},{version:"6.0.0",date:"2025-09-20",changes:"Add fields documentation"},{version:"5.5.10",date:"2025-06-29",changes:"Init history"}],c="./docs/en/dictionary/content_file.md",d="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/content_file.md",m="/doc/concept/content",u="https://intlayer.org/doc/concept/content",p={id:n,content:e,createdAt:t,updatedAt:o,title:i,description:a,keywords:r,slugs:s,history:l,docKey:c,githubUrl:d,relativeUrl:m,url:u};export{e as content,t as createdAt,p as default,a as description,c as docKey,d as githubUrl,l as history,n as id,r as keywords,m as relativeUrl,s as slugs,i as title,o as updatedAt,u as url};
